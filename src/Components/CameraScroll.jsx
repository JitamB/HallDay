...
export default function CameraScroll(props) {
    ...
    return <>
        ...
        <Text
            ...
            position={[-2, 3.1, 0.1]}
            fontSize={0.1}
            rotation-y={Math.PI/22}
            color="#2d1d04"
            material-opacity={0}
        >
            Should I tell you something, hmmm...?
        </Text>
        ...
        <Text
            ref={cssTextRef}
            font="./fonts/Bangers.ttf"
            position={[-3.5, 2.6, 2.15]}
            fontSize={0.05}
            rotation-y={Math.PI/2}
            color="#2d1d04"
            material-opacity={0}
        >
            But do we actually connect?
        </Text>
        ...
        <group >
            <Text
                ...
                font="./fonts/Bangers.ttf"
                position={[-0.5, 3.12, -1.2]}
                fontSize={0.05}
                rotation-y={Math.PI/2}
                color="#2d1d04"
                material-opacity={0}
            >
                Come tonight to our abode, C417 &
            </Text>
            <Text
                ref={threejsCertificationTextRef2}
                font="./fonts/Bangers.ttf"
                position={[-0.5, 3.05, -1.3]}
                fontSize={0.08}
                rotation-y={Math.PI/2}
                color="#2d1d04"
                material-opacity={0}
            >
                Let's forget all the worries for a while
            </Text>
        </group>
        ...
        <group>
            <Text
                ...
                material-opacity={0}
            >
            {/* Enrich our minds with JOY and laughter */}And fill the night with joy and laughter.
            </Text>
            <Text
                ref={licence2TextRef}
                font="./fonts/Bangers.ttf"
